...
import getData from '@salesforce/apex/MergePdfCompHelper.getData';
import getRecordsId from '@salesforce/apex/MergePdfCompHelper.getRecordsId';
...
//                   this.createPdf()
    ...
    async createPdf() {
        ...
        this.saveByteArray("Merged PDF", pdfBytes);
    }
