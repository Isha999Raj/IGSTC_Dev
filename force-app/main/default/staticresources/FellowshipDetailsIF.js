...
$scope.callRTF=function(){
  ...
  $scope.onCountryChange = function(){
    ...
    $scope.getMentorHostDetails = function(){
      debugger;
      ApplicantPortal_Contoller.getMentorHostDetails($rootScope.userId, function(result,event){
        debugger;
  ...
  // }
    if($scope.accDetails.Organisation_Posrt__c==undefined || $scope.accDetails.Organisation_Posrt__c==""){
      ...
      ApplicantPortal_Contoller.saveMentorHostDetails($scope.accDetails,$rootScope.userId,$rootScope.projectId, function(result,event){
          if(event.status){
              debugger;
              Swal.fire(
                  'Success',
