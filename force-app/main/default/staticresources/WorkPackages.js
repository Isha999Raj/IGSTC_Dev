                ...
                if ($scope.applicantDetails.length > 0) {
                    ...
                    for (var i = 0; i < $scope.applicantDetails.length; i++) {
                        ...
                        $scope.workPackList.push({
                            ...
                            "title": $scope.applicantDetails[i].Title__c?$scope.applicantDetails[i].Title__c.replace(/&amp;/g,'&').replace(/&#39;/g,'\'').replaceAll('&amp;amp;','&').replaceAll('&amp;gt;','>').replaceAll('&lt;','<').replaceAll('lt;','<').replaceAll('&gt;','>').replaceAll('gt;','>').replaceAll('&amp;','&').replaceAll('amp;','&').replaceAll('&quot;','\''):$scope.applicantDetails[i].Title__c,
