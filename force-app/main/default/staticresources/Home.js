    ...
    $scope.redirectPageURL=function(URL){
        ...
        if(emailVerified == "false" && $scope.currentCampaignName == "WISER"){
            ...
            swal({
                ...
                text: "Please first verify your email, we have sent a verification link on your registered email. After verification you can submit your proposal. In case you do not receive an email, please check your ‘SPAM’ or ‘JUNK’ folder. If you still fail to find the email, please try reaching us at wiser@igstc.org",
                icon: "warning",
                buttons: true,
                dangerMode: true,
              })
            ...
            swal({
                title: "Email Verification",
                text: "Please first verify your email, we have sent a verification link on your registered email. After verification you can submit your proposal. In case you do not receive an email, please check your ‘SPAM’ or ‘JUNK’ folder. If you still fail to find the email, please try reaching us at workshop@igstc.org",
                icon: "warning",
                buttons: true,
                dangerMode: true,
              })
            ...
            swal({
                title: "Email Verification",
                text: "Please first verify your email, we have sent a verification link on your registered email. After verification you can submit your proposal. In case you do not receive an email, please check your ‘SPAM’ or ‘JUNK’ folder. If you still fail to find the email, please try reaching us at lalitha.pv@igstc.org",
                icon: "warning",
                buttons: true,
                dangerMode: true,
              })
