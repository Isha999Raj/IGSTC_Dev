...
debugger
  ...
  var birthYear=0;
    ...
    IndustrialFellowshipController.saveApplicantPortalSingh($rootScope.userId,$scope.objContact,$scope.accountDet,birthYear,birthMonth,birthDay, function (result, event) {
        debugger
            console.log(result);
            console.log(event);
            if (event.status) {
