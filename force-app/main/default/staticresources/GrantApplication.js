                ...
                for(var i=0;i<$scope.input.length;i++){
                    if($scope.input[i].Existing_Grants__r != undefined){
                        for(var j=0;j<$scope.input[i].Existing_Grants__r.length;j++){
                            ...
                            if($scope.input[i].Existing_Grants__r[j].Title__c != undefined){
                                $scope.input[i].Existing_Grants__r[j].Title__c=$scope.input[i].Existing_Grants__r[j].Title__c.replace(/&amp;/g,'&').replace(/&#39;/g,'\'').replaceAll('&amp;amp;','&').replaceAll('&amp;gt;','>').replaceAll('&lt;','<').replaceAll('lt;','<').replaceAll('&gt;','>').replaceAll('gt;','>').replaceAll('&amp;','&').replaceAll('amp;','&').replaceAll('&quot;','\'');
                            }
                            if($scope.input[i].Existing_Grants__r[j].Funding_Agency__c != undefined){
                                $scope.input[i].Existing_Grants__r[j].Funding_Agency__c=$scope.input[i].Existing_Grants__r[j].Funding_Agency__c.replace(/&amp;/g,'&').replace(/&#39;/g,'\'').replaceAll('&amp;amp;','&').replaceAll('&amp;gt;','>').replaceAll('&lt;','<').replaceAll('lt;','<').replaceAll('&gt;','>').replaceAll('gt;','>').replaceAll('&amp;','&').replaceAll('amp;','&').replaceAll('&quot;','\'');
                            }
                        }
