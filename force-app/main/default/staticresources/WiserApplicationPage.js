...
//   $scope.getContactWiser();
  ...
  // }
    ...
    IndustrialFellowshipController.saveApplicantPortalWiser($scope.objContact,$scope.accDet,birthYear,birthMonth,birthDay,$rootScope.tagCampaignId, function(result, event){
        debugger;
        if (event.status && result !=null) {
